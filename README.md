The following pipeline documents the process of re-assembling the thimbleberry (*Rubus parviflorus*) genome starting with the SRAs from NCBI and ending with an annotated genome.
